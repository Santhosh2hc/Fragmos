...
public class UM_BillingExample : BaseIOSFeaturePreview {
	...
	public const string CONSUMABLE_PRODUCT_ID 		= "small_coins_bag_1";//"coins_pack";// GPaymnetManagerExample.ANDROID_TEST_PURCHASED;	//"ConsumableExample";
	...
	void OnGUI() {
		...
		if(GUI.Button(new Rect(StartX, StartY, buttonWidth, buttonHeight), "Init2")) {
