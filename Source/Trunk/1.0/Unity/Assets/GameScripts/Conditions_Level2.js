...
function checkWinCondition()
{
	...
	if (((tilePos[6].transform.position - POS[3]).magnitude < LOC_TOLERANCE)||((tilePos[5].transform.position - POS[3]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[3]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;		
	}		
	...
	if (((tilePos[6].transform.position - POS[7]).magnitude < LOC_TOLERANCE)||((tilePos[5].transform.position - POS[7]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[7]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}		
