...
function checkWinCondition()
{
	...
	if (((tilePos[7].transform.position - POS[3]).magnitude < LOC_TOLERANCE)||((tilePos[3].transform.position - POS[3]).magnitude < LOC_TOLERANCE)||((tilePos[2].transform.position - POS[3]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;		
	}		
	if (((tilePos[7].transform.position - POS[5]).magnitude < LOC_TOLERANCE)||((tilePos[3].transform.position - POS[5]).magnitude < LOC_TOLERANCE)||((tilePos[2].transform.position - POS[5]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}
	if (((tilePos[7].transform.position - POS[7]).magnitude < LOC_TOLERANCE)||((tilePos[3].transform.position - POS[7]).magnitude < LOC_TOLERANCE)||((tilePos[2].transform.position - POS[7]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}
	...
	if (((tilePos[6].transform.position - POS[1]).magnitude < LOC_TOLERANCE)||((tilePos[5].transform.position - POS[1]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[1]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}
	if (((tilePos[6].transform.position - POS[2]).magnitude < LOC_TOLERANCE)||((tilePos[5].transform.position - POS[2]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[2]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}		
