...
function checkWinCondition()
{
	...
	if (((tilePos[7].transform.position - POS[0]).magnitude < LOC_TOLERANCE)||((tilePos[1].transform.position - POS[0]).magnitude < LOC_TOLERANCE)||((tilePos[2].transform.position - POS[0]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;		
	}		
	if (((tilePos[7].transform.position - POS[2]).magnitude < LOC_TOLERANCE)||((tilePos[1].transform.position - POS[2]).magnitude < LOC_TOLERANCE)||((tilePos[2].transform.position - POS[2]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}
	if (((tilePos[7].transform.position - POS[8]).magnitude < LOC_TOLERANCE)||((tilePos[1].transform.position - POS[8]).magnitude < LOC_TOLERANCE)||((tilePos[2].transform.position - POS[8]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}
	if (((tilePos[6].transform.position - POS[3]).magnitude < LOC_TOLERANCE)||((tilePos[3].transform.position - POS[3]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[3]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;		
	}		
	if (((tilePos[6].transform.position - POS[4]).magnitude < LOC_TOLERANCE)||((tilePos[3].transform.position - POS[4]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[4]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}
	if (((tilePos[6].transform.position - POS[5]).magnitude < LOC_TOLERANCE)||((tilePos[3].transform.position - POS[5]).magnitude < LOC_TOLERANCE)||((tilePos[0].transform.position - POS[5]).magnitude < LOC_TOLERANCE))
	{
	matchCount++;			
	}		
